                    ...
                    <tbody>
                        <c:forEach var="tr" items="${trabajadores}">
                            <tr>
                                ...
                                <td>${tr.getEstado()}</td>
                                <td>
                                    <a class="btn btn-warning" href="control?menu=trabajador&acc=editar&id=${tr.getIdTrabajador()}">Editar</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="control?menu=trabajador&acc=eliminar&id=${tr.getIdTrabajador()}">Eliminar</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
